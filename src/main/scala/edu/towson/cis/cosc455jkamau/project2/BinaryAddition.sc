...
def binaryAddition(pList: List[Int], qList: List[Int]): List[Int] = {
  val intlist1 = pList.reverse
  val intlist2 = qList.reverse
  val bool1: List[Boolean] = convertIntListToBooleanList(intlist1)
  val bool2: List[Boolean] = convertIntListToBooleanList(intlist2)
  val output: List[Boolean] = doBinaryAddition(bool1, bool2, false)
  val intfin: List[Boolean] = output.reverse
  val boolfin: List[Int] = convertBooleanListToIntList(intfin)
  boolfin
}
